 ...
 */
export declare const ASTRO_PATH_TOKEN_PARAM = "x_astro_path_token";
/**
 * The edge function calls the node server at /_render,
...
export default function vercelAdapter({ webAnalytics, includeFiles: _includeFiles, excludeFiles: _excludeFiles, imageService, imagesConfig, devImageService, middlewareMode, edgeMiddleware, maxDuration, isr, skewProtection, staticHeaders, }?: VercelServerlessConfig): AstroIntegration;
export {};
